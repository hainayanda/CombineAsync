...
- Choose **Up to Next Major** for the version rule and set the version to **1.5.0**.
...
```swift
dependencies: [
    .package(url: "https://github.com/hainayanda/CombineAsync.git", .upToNextMajor(from: "1.5.0"))
]
```
